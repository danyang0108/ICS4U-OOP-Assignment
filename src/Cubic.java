...
public class Cubic extends Function implements Calculations, Drawable {
	...
	// variables for the equation y = a(x - x1)^3 + b(x - x1)^2 + c(x - x1) + d
	protected double a;
	protected double b;
	protected double c;
	protected double d;
	...
	// Constructor method for the cubic function
	...
	// Default Constructor method for the cubic function
	public Cubic() {
		super(-100, 100); // default domain, changeable using setStartDomain and setEndDomain
		this.a = 1;
		this.b = 0;
